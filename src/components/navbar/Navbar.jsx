  ...
  const navList = (
    <ul className="flex flex-row justify-evenly text-center items-center space-x-9 text-white font-medium text-md lg:px-5 lg:mx-0 mx-2 w-full">
      ...
      <li className="relative text-md lg:text-lg">
        ...
        {isDropdownOpen && (
          <ul className="absolute top-full left-[-4rem] rounded-xl mt-2 w-48 bg-[#0a2540] text-white shadow-lg">
            <li className=" border hover:border-4 rounded-xl hover:text-[#76d6d0] text-[#00a99d]  border-[#84d7d2] px-4 py-2">
