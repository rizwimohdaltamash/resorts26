        ...
        <div className="flex flex-row h-1/2 justify-center bg-white text-black p-8  shadow-md mb-8">
          <div className=" w-[65%] lg:w-1/2">
            ...
            <button
              ...
              className="bg-[#33c664f8] hover:bg-[#1ca54af8] w-[60%] md:w-1/2 lg:w-1/3 mt-8 py-3 rounded-full text-white text-xl font-semibold shadow-2xl hover:shadow-4xl transition-transform transform hover:-translate-y-1"
            >
              Sell Product
            </button>
          </div>
